...
files.forEach(file => {
  ...
  if (fs.existsSync(filePath)) {
      ...
      content = content.replace(/识材 SHI CAI/g, '真菜');
      content = content.replace(/PinFresh-识材/g, '真菜');
      content = content.replace(/PinFresh 识材/g, '真菜');
      content = content.replace(/识为鲜 PinFresh｜识材/g, '真菜');
      content = content.replace(/PinFresh/g, '真菜');
      content = content.replace(/识为鲜/g, '真菜');
      content = content.replace(/一眼识材/g, '一眼识菜');
      content = content.replace(/识材/g, '真菜');
